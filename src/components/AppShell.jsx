                  ...
                  {checklistRows.map((row) => (
                    <div key={row.id} className="row-card">
                      ...
                      <div className="actions-end">
                        ...
                        <span style={{ textAlign: 'center', justifyContent: 'center' }} className={`badge ${row.submission?.approvedByClient ? '' : 'outline'}`}>{row.submission?.approvedByClient ? 'Aprobado cliente' : 'Sin aprobar'}</span>
