                  ...
                  {checklistRows.map((row) => (
                    <div key={row.id} className="row-card">
                      ...
                      <div className="actions-end">
                        ...
                        <button className="secondary" style={{ width: '90px', textAlign: 'left', fontSize: '12px', padding: '6px 12px' }} onClick={() => { setSelectedDocType(row); setSubmissionOpen(true); }}>Registrar</button>
